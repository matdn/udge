type ProgrammeTocItem = {
  href: string;
  label: string;
  description?: string;
};

export const programmeToc: ProgrammeTocItem[] = [
  {
    href: "#democratie-transparence",
    label: "1. Démocratie & transparence",
    description: "Pouvoir citoyen, droits de l’opposition, budgets participatifs",
  },
  {
    href: "#petite-enfance-ecoles-jeunesse",
    label: "2. Petite enfance / écoles / jeunesse",
    description: "Espaces jeunes, conseils, crèches, vie scolaire",
  },
  {
    href: "#solidarites-sante-logement",
    label: "3. Solidarités / santé / logement",
    description: "Budget, commerce, logement, droits, santé",
  },
  {
    href: "#ecologie-mobilites-alimentation",
    label: "4. Écologie / mobilités / alimentation",
    description: "Biodiversité, énergie, vélo, restauration scolaire",
  },
  {
    href: "#culture-sport-convivialite",
    label: "5. Culture / sport / convivialité",
    description: "Tiers-lieu, accès équitable, vie locale",
  },
  {
    href: "#prevention-securite",
    label: "6. Prévention / sécurité",
    description: "Présence humaine, médiation, accessibilité",
  },
  { href: "#conclusion", label: "Conclusion" },
];

export function ProgrammeContent() {
  return (
    <>
      <section id="democratie-transparence" className="card p-7 md:p-9">
        <h2 className="programme-h2">1. DÉMOCRATIE & TRANSPARENCE</h2>
        ...
        <p className="programme-p">
          ...
          ouverte et intergénérationnelle, qui associe réellement les citoyens aux décisions qui transforment leur ville.
        </p>
      ...
      <section id="petite-enfance-ecoles-jeunesse" className="card p-7 md:p-9">
        <h2 className="programme-h2">2. PETITE ENFANCE / ÉCOLES / JEUNESSE</h2>
        <p className="programme-lead">
        ...
        <h3 className="programme-h3">2.3. Une action engagée pour la petite enfance</h3>
        <p className="programme-p">
        ...
        <h3 className="programme-h3">2.4. Un engagement fort pour améliorer la vie scolaire</h3>
        <p className="programme-p">
      ...
      <section id="solidarites-sante-logement" className="card p-7 md:p-9">
        <h2 className="programme-h2">3. SOLIDARITÉS / SANTÉ / LOGEMENT</h2>
        <p className="programme-lead">
        ...
        <h3 className="programme-h3">3.4. Accès aux droits et accompagnement social</h3>
        <ul className="programme-ul">
          <li>
        ...
        <h3 className="programme-h3">3.5. Accès aux soins pour toutes et tous</h3>
        <p className="programme-p">
      ...
      <section id="ecologie-mobilites-alimentation" className="card p-7 md:p-9">
      ...
      <section id="culture-sport-convivialite" className="card p-7 md:p-9">
        <h2 className="programme-h2">5. CULTURE / SPORT / CONVIVIALITÉ</h2>
        <p className="programme-lead">
          <strong>Une ville vivante : accès équitable, lieux de rencontre, initiatives citoyennes.</strong>
        </p>

        <h3 className="programme-h3">5.1. Un accès équitable au sport et à la culture</h3>
        ...
        <h3 className="programme-h3">5.2. De nouveaux lieux de convivialité et d’engagement intergénérationnel</h3>
        <p className="programme-p">
      ...
      <section id="prevention-securite" className="card p-7 md:p-9">
        <h2 className="programme-h2">6. PRÉVENTION / SÉCURITÉ</h2>
        <p className="programme-lead">
          <strong>
        ...
        <h3 className="programme-h3">6.1. Priorité à la présence humaine et à la prévention</h3>
        <ul className="programme-ul">
          <li>
        ...
        <h3 className="programme-h3">6.2. Refus de la surveillance de masse</h3>
        <ul className="programme-ul">
          <li>
        ...
        <h3 className="programme-h3">6.3. Respect de la loi républicaine et égalité</h3>
        <ul className="programme-ul">
          <li>
        ...
        <h3 className="programme-h3">6.4. La sécurité, c’est aussi des engagements concrets pour tous</h3>
        <ul className="programme-ul">
          <li>
